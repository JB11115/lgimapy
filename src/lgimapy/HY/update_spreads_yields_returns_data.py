...
def main():
    ...
    update_hedged_total_return_data()
    update_excess_return_data()
...
def update_hedged_total_return_data():
    """Scrape total return data from Bloomberg and save file."""
    db = Database()
    tret_fid = root("data/HY/report_total_returns_hedged.csv")
    index_names = {
        "US_HY": "LF98",
        "US_BB": "BCBA",
        "US_B": "BCBH",
...
def update_excess_return_data():
    """Scrape total return data from Bloomberg and save file."""
    db = Database()
    xsret_fid = root("data/HY/report_excess_returns.csv")
    index_names = {
        "US_HY": "LF98",
        "US_BB": "BCBA",
        "US_B": "BCBH",
