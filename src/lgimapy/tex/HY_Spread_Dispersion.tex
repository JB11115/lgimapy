...
\begin{figure}[H]
	\centering
	%\caption{}
	\includegraphics[width=0.9\textwidth]{fig/MV_BB_timeseries}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/MV_BB_abs_jointplot}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/MV_BB_rel_jointplot}
	\end{subfigure}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	\centering
	%\caption{}
	\includegraphics[width=0.9\textwidth]{fig/Issuer_BB_timeseries}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/Issuer_BB_abs_jointplot}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/Issuer_BB_rel_jointplot}
	\end{subfigure}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	\centering
	%\caption{}
	\includegraphics[width=0.9\textwidth]{fig/MV_B_timeseries}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/MV_B_abs_jointplot}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/MV_B_rel_jointplot}
	\end{subfigure}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	\centering
	%\caption{}
	\includegraphics[width=0.9\textwidth]{fig/Issuer_B_timeseries}
\end{figure}
\begin{figure}[H]
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/Issuer_B_abs_jointplot}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{fig/Issuer_B_rel_jointplot}
	\end{subfigure}
\end{figure}
\pagebreak
