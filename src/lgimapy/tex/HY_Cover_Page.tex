...
\fancyhead[L]{US HY Credit Markets}
\fancyhead[R]{\today}
\fancyfoot[L]{\thepage}
\fancyfoot[R]{
...
\fancypagestyle{title}{
	...
	\fancyhf{}
	\fancyhead[L]{\Huge \textbf{US HY Credit Markets}\\ \LARGE \today}
	\fancyhead[R]{
...
%% Cover Page
\thispagestyle{title}
\bookmark[page=1, level=0]{Cover Page}
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{0.485\textwidth}
		\centering
		%\caption{}
		\includegraphics[width=1\textwidth]{fig/cover_H4UN}
		\vskip1em
	...
	\begin{subfigure}[b]{0.485\textwidth}
		\centering
		%\caption{}
		\includegraphics[width=1\textwidth]{fig/HY_spreads_cover_page}
		\vskip1em
		\includegraphics[width=1\textwidth]{fig/bonds_trading_above_call_price}
	\end{subfigure}
