Instructions for completing the programming assessment for
the LGIM America Associate Strategist role.

1) Open `Programming_Assessment_Associate_Strategist.py` file and
